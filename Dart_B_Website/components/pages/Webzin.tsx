...
export function Webzin() {
  ...
  // Mock webzine data - 3기=24년 1학기, 4기=24년 2학기, 5기=25년 1학기
  const webzines = {
    '5': {
      title: '5기 DArt-B 웹진',
    ...
    '3': {
      title: '3기 DArt-B 웹진',
      description: '2024년 3기 활동 내용을 담은 웹진입니다.',
      pdfUrl: '/webzin/dartb_3rd.pdf'
    },
    '2': {
      title: '2기 DArt-B 웹진',
      description: '2023년 2기 활동 내용을 담은 웹진입니다.',
      pdfUrl: '/webzin/dartb_2nd.pdf'
    },
    '1': {
      title: '1기 DArt-B 웹진',
      description: '2023년 1기 활동 내용을 담은 웹진입니다.',
      pdfUrl: '/webzin/dartb_1st.pdf'
    }
  };
